...
```
Qn 1: We need 6 components to explain at least 50% of the variance
Qn 2: 0.93
Qn3: The first 10 components can be called the "principal components". Together they account for 62.61% of the variance in the sample

```


Qn4: Part a- the pre-crisis bull market years (data between November 1, 2002, and October 1, 2007)
...
Part b- the financial crisis years (data between October 1, 2007 and March 1, 2009)
...
```
Qn 5: The charts above show that in the pre-crisis bull market, 15 principal components had an eigenvalue >1 which accounted for 69.95% of cumulative explained variance. In contrast, in the financial crisis years only 13 principal components have an eigenvalue >1 which accounts for 75.4% of cumulative explained variance. In addition, the scree plot becomes much steeper in crisis years with the first eigenvalue increasing its value from approximately 11-19 which shows that in crisis years one component takes much more responsibility for the variance.

Therefore in financial crisis years less components are responsible for more the the variance, which suggests there are fewer key factors to explain the changes in the markets.
```
<br>
...
Qn2:
Changing the sequence shows the effect of different looking back windows. Changing these paramteres alters profit and loss and therefore returns
