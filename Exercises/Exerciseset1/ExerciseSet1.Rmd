...
```
I have found the following interesting finance packages:
...
portfolios. Key for portfolio optimisation and risk management
```
...
**Your Answers here:**
```
1. This command gives me a sum of stock returns 0.466 if I run:
